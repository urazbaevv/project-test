...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['PUT'])) {
    ...
    $_SESSION['post-ozgertildi'] = 'Post ozgertildi';
...
<div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
            ...
            <span class="fs-4">Post ozgertiw</span>
        </a>
    </header>
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <form method="POST" action="" class="container-fluid py-5">
            ...
            <h1><?= $post['id']?></h1>
            <div class="mb-3">
                <label class="form-label">Temasi</label>
                <input name="title" type="text" class="form-control" placeholder="Temasin jazin" value="<?= $post['title']?>">
            </div>
            <div class="mb-3">
            ...
            <a href="index.php"><button type="submit" class="btn btn-primary justify-right ml-80">Arqaga qaytiw</button></a>
        </form>
    </div>
</div>
